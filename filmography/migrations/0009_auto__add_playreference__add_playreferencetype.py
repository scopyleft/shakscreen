...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PlayReference'
        db.create_table('filmography_playreference', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('play', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filmography.Play'])),
            ('film', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filmography.Film'])),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filmography.PlayReferenceType'])),
            ('summary', self.gf('django.db.models.fields.TextField')()),
            ('body', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('filmography', ['PlayReference'])

        # Adding model 'PlayReferenceType'
        db.create_table('filmography_playreferencetype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('reference', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
        ))
        db.send_create_signal('filmography', ['PlayReferenceType'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PlayReference'
        db.delete_table('filmography_playreference')

        # Deleting model 'PlayReferenceType'
        db.delete_table('filmography_playreferencetype')
    ...
    models = {
        ...
        'filmography.playreference': {
            ...
            'film': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filmography.Film']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'play': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filmography.Play']"}),
