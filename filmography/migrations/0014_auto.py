...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field scriptwriters on 'Film'
        db.create_table('filmography_film_scriptwriters', (
        ...
        db.create_unique('filmography_film_scriptwriters', ['film_id', 'character_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field scriptwriters on 'Film'
        db.delete_table('filmography_film_scriptwriters')
