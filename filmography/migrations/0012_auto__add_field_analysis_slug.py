...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Analysis.slug'
        db.add_column('filmography_analysis', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Analysis.slug'
        db.delete_column('filmography_analysis', 'slug')
