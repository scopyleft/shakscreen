...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Film.publisher'
        db.alter_column('filmography_film', 'publisher', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Film.publish_date'
        db.alter_column('filmography_film', 'publish_date', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Film.publisher'
        db.alter_column('filmography_film', 'publisher', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Film.publish_date'
        db.alter_column('filmography_film', 'publish_date', self.gf('django.db.models.fields.IntegerField')(default=''))
    ...
    models = {
        'filmography.analysis': {
            ...
            'contributors': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'analyses'", 'symmetrical': 'False', 'to': "orm['filmography.Contributor']"}),
            'films': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'analyses'", 'symmetrical': 'False', 'to': "orm['filmography.Film']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'filmography.character': {
            'Meta': {'ordering': "['firstname']", 'object_name': 'Character'},
        ...
        'filmography.film': {
            'Meta': {'ordering': "['title_fr', '-release_date']", 'object_name': 'Film'},
            ...
            'contributor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'films'", 'to': "orm['filmography.Contributor']"}),
            ...
            'publish_date': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'scriptwriters': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'scriptwriter_films'", 'symmetrical': 'False', 'to': "orm['filmography.Character']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'True'}),
