...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Film.title_aka'
        db.add_column('filmography_film', 'title_aka', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Film.title_aka'
        db.delete_column('filmography_film', 'title_aka')
    ...
    models = {
        ...
        'filmography.film': {
            'Meta': {'ordering': "['slug', '-release_date']", 'object_name': 'Film'},
            ...
            'title_aka': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
