...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlayReference.description'
        db.rename_column('filmography_playreference', 'summary', 'description')

        # Adding field 'PlayReference.quotation'
        db.rename_column('filmography_playreference', 'body', 'quotation')


    def backwards(self, orm):
        
        # Adding field 'PlayReference.description'
        db.rename_column('filmography_playreference', 'description', 'summary')

        # Adding field 'PlayReference.quotation'
        db.rename_column('filmography_playreference', 'quotation', 'body')
